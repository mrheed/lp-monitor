...
export default defineConfig({
  ...
  test: {
    ...
    // and are invoked explicitly with `npm run test:live`. The `hook/` Foundry project and the
    // vendored v4 Solidity submodules carry their own JS tests that are not part of this app.
    exclude: [
      '**/node_modules/**',
      '**/*.live.test.ts',
      'hook/**',
